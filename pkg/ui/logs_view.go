...
// LogsView implements standard tea.Model interface
...
// NewLogsViewWithConfig creates a new v2 logs view with configuration
func NewLogsViewWithConfig(cfg *config.Config, logger zerolog.Logger) *LogsView {
...
func (lv *LogsView) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	lv.logger.Debug().Str("method", "Update").Interface("msgType", msg).Msg("LogsView.Update called")
...
func (lv *LogsView) View() string {
	lv.logger.Debug().Str("method", "View").Msg("LogsView.View called")
...
func (lv *LogsView) updateViewport() {
...
func (lv *LogsView) KeyMap() help.KeyMap {
...
func (lv *LogsView) FooterView() string {
...
func (lv *LogsView) IsCapturingInput() bool {
